...
import pe.edu.upeu.proyectoventas.modelo.CategoriaDAO;
...
cboCategoria.setModel(modelocombo);
    ...
    private void initComponents() {
        ...
        if (tbproducto.getColumnModel().getColumnCount() > 0) {
            tbproducto.getColumnModel().getColumn(0).setMaxWidth(30);
        }
    ...
    private void cboCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboCategoriaActionPerformed
        ...
        String cat1 = cboCategoria.getSelectedItem().toString();
        int id;
        int x = cboCategoria.getSelectedIndex();
        if(x!=0){
         id = cdao.retorIdCategoria(cat1);
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        ...
        int z = pdao.registrarProducto(idc, prod, pre, can);
        if(z>0){
